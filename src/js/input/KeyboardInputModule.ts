...
export class KeyboardInputModule {
  ...
  GetStringNote(key) {
    switch (key) {
      case "A":
        return MIDIDataTable.MIDINoteToString(60); //C
      case "W":
        return MIDIDataTable.MIDINoteToString(61); //Cä
      case "S":
        return MIDIDataTable.MIDINoteToString(62); //D
      case "E":
        return MIDIDataTable.MIDINoteToString(63); //D#
      case "D":
        return MIDIDataTable.MIDINoteToString(64); //E
      case "F":
        return MIDIDataTable.MIDINoteToString(65); //F
      case "T":
        return MIDIDataTable.MIDINoteToString(66); //F#
      case "G":
        return MIDIDataTable.MIDINoteToString(67); //G
      case "Z":
        return MIDIDataTable.MIDINoteToString(68); //G#
      case "H":
        return MIDIDataTable.MIDINoteToString(69); //A
      case "U":
        return MIDIDataTable.MIDINoteToString(70); //A#
      case "J":
        return MIDIDataTable.MIDINoteToString(71); //B
    }
  }
