...
export default function SetupContainer(props: { channel: number }) {
  ...
  async function GetSearchResult(searchStr: string) {
    if (toy != undefined && presetManager != undefined) {
      ...
      var data = await presetManager.SearchPresetsOnline(
        toy.toyType,
        searchStr,
      );
            ...
            <div class="flexContainer">
              ...
              <div class="flex justifyEnd width20 marginTopBottomAuto">
                <ui.ButtonIcon
                  ...
                  divClass="marginRight5"
                  onClick={() =>
                    DownloadPreset(item.presetName, item.presetData)
                  }
                />
                <ui.ButtonIcon
                  icon="material-symbols:delete-outline"
    ...
    return (
      <div>
        ...
        <div class="justifyCenter">
          <ui.JsonFileUploader onFileUpload={UploadExistingPresetOnline} />
        </div>
      </div>
    );
  }
  ...
  function RenderLocalPresetManagement() {
    return (
      <div>
        ...
        <br></br>
        <div class="justifyCenter">
          <ui.JsonFileUploader onFileUpload={UploadPresetLocal} />
        </div>
      </div>
    );
  }
  ...
  function RenderOnlineFunctionSelection() {
    switch (onlineFunctionSelection()) {
      case 0: //My Presets
        return <div>{RenderMyOnlinePresetsTab()}</div>;
      case 1: //Browse for presets
        return <div>{RenderSearchPresetsTab()}</div>;
      case 2: //New
        return (
          <div>
