...
export default function SetupContainer() {
  ...
  const [backGroundColor, setBackgroundColor] = createSignal<RGBA>({
    r: 0,
    g: 0,
    b: 0,
    a: 0,
  ...
  function RenderContainer() {
    switch (selectedChannel()) {
      ...
      case 1:
        return <ToyContainer channel={1} />;
      case 2:
        return <ToyContainer channel={2} />;
      case 3:
        return <ToyContainer channel={3} />;
      case 4:
        return <ToyContainer channel={4} />;
      case 5:
        return <ToyContainer channel={5} />;
      case 6:
        return <ToyContainer channel={6} />;
      case 7:
        return <ToyContainer channel={7} />;
      case 8:
        return <ToyContainer channel={8} />;
      case 9:
        return <ToyContainer channel={9} />;
      case 10:
        return <ToyContainer channel={10} />;
      case 11:
        return <ToyContainer channel={11} />;
      case 12:
        return <ToyContainer channel={12} />;
      case 13:
        return <ToyContainer channel={13} />;
      case 14:
        return <ToyContainer channel={14} />;
      case 15:
        return <ToyContainer channel={15} />;
      case 16:
        return <ToyContainer channel={16} />;
    }
  }
  ...
  function RenderHeadline() {
    if (selectedChannel() > 0) {
      ...
      switch (selectedChannel()) {
        case 0:
          return <h1 class="marginAuto marginLeft5">Settings</h1>;
        case -1:
          return <h1 class="marginAuto marginLeft5">Account</h1>;
      }
    }
  }
    ...
    return (
      <div class="height10 width100">
        <div class="flexContainer">
          <div class="justifyStart textAlignLeft">{RenderHeadline()}</div>
          <div class="justifyEnd">{RenderCloseButton()}</div>
        </div>
      </div>
    );
  }
