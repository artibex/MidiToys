...
export default function SetupContainer(props: { channel: number }) {
  ...
  const [colorSelectionName, setColorSelectionName] =
    createSignal("Fill Color");
  const [fillColor, setFillColor] = createSignal<RGBA>({
    r: 0,
    g: 0,
    b: 0,
    a: 0,
  });
  const [strokeColor, setStrokeColor] = createSignal<RGBA>({
    r: 0,
    g: 0,
    b: 0,
    a: 0,
  });
  const [accentColor, setAccentColor] = createSignal<RGBA>({
    r: 0,
    g: 0,
    b: 0,
    a: 0,
        ...
        return (
          <div>
            <ui.NumberSliderUIElement
              ...
              value={strokeColor().r}
              onChange={(value) =>
                setStrokeColor({ ...strokeColor(), r: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Green"}
              ...
              value={strokeColor().g}
              onChange={(value) =>
                setStrokeColor({ ...strokeColor(), g: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Blue"}
              ...
              value={strokeColor().b}
              onChange={(value) =>
                setStrokeColor({ ...strokeColor(), b: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Alpha"}
              ...
              value={strokeColor().a}
              onChange={(value) =>
                setStrokeColor({ ...strokeColor(), a: value })
              }
            />
          </div>
        );
        ...
        return (
          <div>
            <ui.NumberSliderUIElement
              ...
              value={accentColor().r}
              onChange={(value) =>
                setAccentColor({ ...accentColor(), r: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Green"}
              ...
              value={accentColor().g}
              onChange={(value) =>
                setAccentColor({ ...accentColor(), g: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Blue"}
              ...
              value={accentColor().b}
              onChange={(value) =>
                setAccentColor({ ...accentColor(), b: value })
              }
            />
            <ui.NumberSliderUIElement
              name={"Alpha"}
              ...
              value={accentColor().a}
              onChange={(value) =>
                setAccentColor({ ...accentColor(), a: value })
              }
            />
          </div>
        );
